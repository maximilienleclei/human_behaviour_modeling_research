"""Data loading and preprocessing functions for Experiment 4."""
...
def load_human_data(
    ...
    optim_episode_boundaries: list[tuple[int, int]] = []  # NEW: (start_idx, length)

    test_observations: list[list[float]] = []
    test_actions: list[int] = []
    test_norm_sessions: list[float] = []
    test_norm_runs: list[float] = []
    test_episode_boundaries: list[tuple[int, int]] = []  # NEW: (start_idx, length)
    ...
    metadata: dict = {
        ...
        "optim_episode_boundaries": optim_episode_boundaries,  # NEW
        "test_episode_boundaries": test_episode_boundaries,  # NEW
    }
