"""Human behavioral data loader for SimExp control tasks.

Loads human gameplay episodes from JSON files with optional continual learning
features (session/run IDs).
"""
...
def load_human_data(
    ...
    data_file: Path = DATA_DIR / "simexp_control_tasks" / "source" / data_filename
